...
// Ultrasonic Sensors
// -----------------------------
#define usp_left_trig 15 // Output, safe
#define usp_left_echo 2  // Input, safe (LOW at boot)

#define usp_right_trig 1  // Safer than 0, output
#define usp_right_echo 35 // Input-only, perfect for ECHO

// -----------------------------
// Actuators
// -----------------------------
#define actuator_pull 14 // Output
#define actuator_push 33 // Output

// -----------------------------
// Light Indicators
// -----------------------------
#define red_light 4    // Output
#define green_light 13 // Output

// -----------------------------
// RFID Scanner (UART)
// -----------------------------
#define rfid_rx 16 // UART RX
#define rfid_tx 17 // UART TX

// -----------------------------
// Fingerprint Scanner (UART)
// -----------------------------
#define fps_rx 25 // UART RX
#define fps_tx 26 // UART TX

// -----------------------------
// Alarm / Buzzer
// -----------------------------
#define buzzer 32 // Output (supports PWM)

// -----------------------------
// Button
// -----------------------------
#define mode_button 27 // Input with internal pull-up

// -----------------------------
// Micro SD Card Module (SPI)
// -----------------------------
#define sm_cs 5    // CS pin
#define sm_mosi 23 // MOSI
#define sm_miso 19 // MISO
#define sm_sck 18  // SCK
